class gaWrapper {
	...
	_click(e) {
		let target = $(e.target);
		let category = this._hasAttr($(target),'$ga-category');
		let label = this._hasAttr($(target),'$ga-label');
		let action = this._hasAttr($(target),'$ga-action');

		let categoryPrefix = this._hasAttr($(target),'$ga-category-prefix');
		let labelPrefix = this._hasAttr($(target),'$ga-label-prefix');
		let actionPrefix = this._hasAttr($(target),'$ga-action-prefix');
